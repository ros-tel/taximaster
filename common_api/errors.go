...
var (
	...
	ErrCarInaccessibilityNotFound    = errors.New("common_api: Недоступность автомобиля не найдена")
	ErrDriverInaccessibilityNotFound = errors.New("common_api: Недоступность водителя не найдена")
